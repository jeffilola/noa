...
| **M7: Learning records** | Training/cert on access decision panel and holder Training & certs page | Done (PR #57 + holder route follow-up) |
...
**Overnight note (2026-07-17):** The old M7–M11 cron prompt is stale because PR #57 is merged and issues #52–#56/#69–#72 are closed. Tonight's review branch focuses on the remaining M7 testing-guide gap: `/user/compliance` and the holder sidebar Training & certs path.
